...
import QfareLandingPage from "./pages/QfareLandingPage.jsx";
import QfareTerms from "./pages/QfareTerms.jsx";
import QfareRefundPolicy from "./pages/QfareRefundPolicy.jsx";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route
          path="/qfare-refund-policy"
          element={<QfareRefundPolicy />}
        />
        <Route
          path="/faqs"
          element={<FaqsPage />}
