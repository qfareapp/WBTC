...
const TripInstanceSchema = new mongoose.Schema(
  {
    ...
    conductorEndedAt: { type: Date, default: null },
    ...
    lastLocationName: { type: String, default: null },
    approachingStop: { type: String, default: null },
    passedStops: [{ type: String }],
    notifiedStops: [{ type: String }],
    driverLastLatitude: { type: Number, default: null },
    driverLastLongitude: { type: Number, default: null },
    driverLastLocationAt: { type: Date, default: null },
